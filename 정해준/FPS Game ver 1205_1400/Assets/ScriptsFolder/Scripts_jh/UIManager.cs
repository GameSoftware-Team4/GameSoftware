...
{    //resource use
    ...
    private void Start()
    {
        ...
        keepMonstertxt = GameObject.Find("Canvas/Game Panel/Enemy Group/Enemy A Text").GetComponent<Text>();
    ...
    private void LateUpdate()
    {
        ...
        keepMonstertxt.text = "x" + enemy.keepMonsterCnt;
        skill_select();
        CheckBullet();
