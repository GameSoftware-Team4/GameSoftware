...
public class Skill_set : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        w1Img = Resources.Load<Image>("prefabs_jhj/W1");
        w2Img = Resources.Load<Image>("prefabs_jhj/W2");
        w3Img = Resources.Load<Image>("prefabs_jhj/W3");
        w4Img = Resources.Load<Image>("prefabs_jhj/W4");
        w5Img = Resources.Load<Image>("prefabs_jhj/W5");
        w6Img = Resources.Load<Image>("prefabs_jhj/WV");
